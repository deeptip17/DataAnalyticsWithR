...
heart_data <- read.csv("~/archivos data analytics/Projects/Project 1 - Heart disease/heart_data.csv")
...
#Classificating bmi accord to the World Health Organization classification:
...
#capitalizing the first letter of the name of each column
